...
window.onload = () => {
  const shortenAnswer = (answer) => {
    ...
    for (
      let i = 0;
      i < (answer.length > 100 ? 100 : answer.length);
      i = i + 1
    ) {
  ...
  fetch("https://dashabhujamain1.azurewebsites.net/news")
    .then((res) => res.json())
    .then((res) => {
          ...
          content =
            ...
            `<div class="col-12 col-lg-4" style="padding: 5px">
                          ...
                          <div class="card-body">
                              ...
                              <p class="card-text">${shortenAnswer(
                                ele.description
                              )}.....</p>
                              <a href=${
                                ele.url
                              } class="btn women-news-btn">Read more</a>
                          </div>
                          </div>
                      </div>`;
        }
