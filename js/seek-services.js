...
window.onload = () => {
  ...
  document.getElementById("prodSearch").addEventListener("input", () => {
    fetch(
      "https://dashabhujamain1.azurewebsites.net/services/search?q=" +
  ...
  fetch("https://dashabhujamain1.azurewebsites.net/services/getall", {
    method: "GET",
    headers: {
...
function registerInterest(event) {
  ...
  fetch("https://dashabhujamain1.azurewebsites.net/services/interested", {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
      Authorization: token,
