...
window.onload = () => {
      ...
      fetch(
        ...
        .then((res) => {
          if (
            ...
            fetch(
              "https://dashabhujamain1.azurewebsites.net/askdesk/add/question",
              {
                method: "POST",
                headers: {
                  "Content-Type": "application/json",
  ...
  document.getElementById("quesSearch").addEventListener("input", (event) => {
    ...
    fetch("https://dashabhujamain1.azurewebsites.net/askdesk/search?q=" + query)
      .then((res) => res.json())
      .then((res) => {
    ...
    fetch(
      ...
      .then((res) => {
        ...
        if (
          ...
          document.getElementById("answer-modal-btn").value = "Please Wait...";
          fetch(
            "https://dashabhujamain1.azurewebsites.net/askdesk/add/answer",
            {
              method: "POST",
              headers: {
                "Content-Type": "application/json",
